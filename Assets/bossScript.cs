...
public class bossScript : MonoBehaviour
{
    public int index = 0;
    public int score = 0;
    private char[] correctAnswers = {'D', 'B', 'B', 'A', 'C', 'A', 'C', 'B', 'C', 'D'};
    ...
    public void nextQuestion(string temp)
    {
        ...
        else
        {
            ...
            finalScore.GetComponent<UnityEngine.UI.Text>().text = "You have completed the pre-quiz. Score: " + score.ToString() + "/100";
        }
