...
public class XRKnob : XRBaseInteractable
{
    ...
    private float FindRotationValue()
    {
        ...
        Vector3 rotatedForward = rotationDifference * knobTransform.up;
        return (Vector3.SignedAngle(knobTransform.up, rotatedForward, transform.forward));
    }
    ...
    private float ApplyRotation(float angle)
    {
        ...
        eulerRotation.z = ClampAngle(eulerRotation.z);
